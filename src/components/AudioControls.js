...
import { canUseVoice, usesSyntheticVoiceVisualizer } from '../utils/voiceDevice';
...
const AudioControls = ({
  ...
  const syntheticVisualizer = usesSyntheticVoiceVisualizer(windowWidth);
      ...
      <AnimatePresence>
        {voiceModeActive && (
          <VoiceVisualizer
            ...
            syntheticVisualizer={syntheticVisualizer}
          />
        )}
      </AnimatePresence>
    </div>
